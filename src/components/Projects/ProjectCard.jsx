...
const ProjectCard = () => {
    ...
    console.log("projArray:", projArray); // Agrega esta línea para verificar el contenido de projArray

    return (
        <div className="projects">
            {projArray?.map((proj, index) => {
                console.log("proj:", proj); // Agrega esta línea para verificar el contenido de cada proyecto
                console.log("proj.img:", proj.img); // Agrega esta línea para verificar el contenido de proj.img
